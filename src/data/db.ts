...
function seedLabItems(): LabItem[] {
  ...
  return [
    ...
    { id: 'lab_005', caseId: 'case_005', clinicId: 'clinic_parceira', patientId: 'pat_luiza_ferreira', dentistId: 'dent_parceiro_2', productType: 'contencao', productId: 'contencao', requestCode: 'OS-1005', requestKind: 'producao', expectedReplacementDate: daysFromNow(30), arch: 'ambos', trayNumber: 1, plannedUpperQty: 1, plannedLowerQty: 1, planningDefinedAt: timestamp, plannedDate: daysFromNow(5), dueDate: daysFromNow(15), status: 'aguardando_iniciar', priority: 'Baixo', notes: 'Reposição solicitada manualmente.', patientName: 'Luiza Ferreira', createdAt: timestamp, updatedAt: timestamp },
